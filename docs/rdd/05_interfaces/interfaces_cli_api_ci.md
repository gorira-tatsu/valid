...
すべての失敗応答は `diagnostics` 配列を返す。各要素は [diagnostic_bundle.schema.json](/Users/tatsuhiko/code/valid/docs/rdd/09_reference/schemas/diagnostic_bundle.schema.json) に従う。
