...
関連ID: `FR-001`〜`FR-005`, `FR-021`, `FR-041`, `FR-060`, `NFR-040`
...
関連ID: `UC-01`〜`UC-07`, `FR-020`〜`FR-073`
...
関連ID: `FR-030`〜`FR-032`, `FR-062`, `FR-070`〜`FR-073`, `NFR-020`, `NFR-032`
...
関連ID: `NFR-021`, `NFR-022`, `NFR-032`, `Phase 4`
...
関連ID: `FR-001`〜`FR-014`, `A-1`〜`A-5`, `PR-01`
...
関連ID: `FR-020`〜`FR-024`, `C-1`〜`C-7`, `I-1`〜`I-4`, `PR-03`, `PR-10`
...
関連ID: `FR-021`, `FR-031`, `FR-040`〜`FR-043`, `D-1`〜`D-5`, `E-1`〜`E-5`, `PR-04`, `PR-06`
...
関連ID: `FR-060`〜`FR-073`, `F-1`〜`F-4`, `H-1`〜`H-5`, `PR-07`, `PR-09`
...
関連ID: `A-1`〜`A-5`, `FR-001`〜`FR-005`, `FR-012`, `PR-01`
...
関連ID: `B-1`〜`B-5`, `FR-011`, `NFR-040`, `PR-02`
...
関連ID: `C-1`〜`C-7`, `FR-020`〜`FR-024`, `PR-03`
...
関連ID: `I-1`〜`I-4`, `FR-023`, `Phase 4`, `PR-10`
...
関連ID: `FR-020`〜`FR-024`, `FR-070`〜`FR-073`, `H-2`, `I-1`
...
関連ID: `E-1`〜`E-5`, `FR-040`〜`FR-043`, `PR-06`
...
関連ID: `G-1`〜`G-5`, `FR-050`〜`FR-053`, `PR-08`
...
関連ID: `D-2`, `D-3`, `FR-030`〜`FR-032`, `PR-04`
...
関連ID: `H-1`〜`H-5`, `FR-070`〜`FR-073`, `PR-09`
...
アーキテクチャ上、SSOTは単なる規約ではなく配線設計として表現される。
