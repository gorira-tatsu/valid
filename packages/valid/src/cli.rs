...
const MODEL_FILE_ARG: ArgSpec = ArgSpec {
    ...
    multiple: false,
    positional: true,
    description: "DSL file path, bundled Rust model ref, or project model id.",
    values: &[],
};
...
const CRITICAL_ARG: ArgSpec = ArgSpec {
    name: "critical",
    syntax: "--critical",
    value_type: "boolean",
    required: false,
    multiple: false,
    positional: false,
    description: "Run the critical property suite from valid.toml.",
    values: &[],
};
const SUITE_NAME_ARG: ArgSpec = ArgSpec {
    name: "suite_name",
    syntax: "--suite=<name>",
    value_type: "string",
    required: false,
    multiple: false,
    positional: false,
    description: "Named property suite from valid.toml.",
    values: &[],
};
...
const VALID_COMMANDS: &[CommandSpec] = &[
    ...
    CommandSpec {
        name: "benchmark",
        aliases: &["bench"],
        description: "Benchmark a project model.",
    ...
    CommandSpec {
        name: "migrate",
        aliases: &[],
        description: "Generate migration snippets for a project model.",
    ...
    CommandSpec {
        name: "suite",
        aliases: &[],
        description: "Run verification across project models.",
    ...
    CommandSpec {
        ...
        usage: "valid check <target> [--json] [--progress=json] [--property=<id>] [--profile=<id>] [--scenario=<id>] [--backend=<explicit|mock-bmc|sat-varisat|smt-cvc5|command>] [--solver-exec <path>] [--solver-arg <arg>]",
        positional: &[MODEL_FILE_ARG],
    ...
    CommandSpec {
        ...
        usage: "valid graph <target> [--format=mermaid|dot|svg|text|json] [--view=overview|logic|failure|deadlock|scc] [--property=<id>] [--profile=<id>] [--json] [--progress=json]",
        positional: &[MODEL_FILE_ARG],
    ...
    CommandSpec {
        ...
        usage: "valid handoff <target> [--json] [--progress=json] [--property=<id>] [--profile=<id>] [--backend=<explicit|mock-bmc|sat-varisat|smt-cvc5|command>] [--solver-exec <path>] [--solver-arg <arg>] [--write[=<path>]] [--check]",
        positional: &[MODEL_FILE_ARG],
    ...
    CommandSpec {
        ...
        usage: "valid explain <target> [--json] [--progress=json] [--property=<id>] [--profile=<id>] [--scenario=<id>] [--backend=<...>] [--solver-exec <path>] [--solver-arg <arg>]",
        positional: &[MODEL_FILE_ARG],
    ...
    CommandSpec {
        ...
        usage: "valid contract <snapshot|lock|drift> <target> [lock-file] [--json] [--progress=json]",
    ...
    CommandSpec {
        ...
        usage: "valid trace <target> [--format=mermaid-state|mermaid-sequence|json] [--property=<id>] [--profile=<id>] [--scenario=<id>] [--json] [--progress=json] [--backend=<...>] [--solver-exec <path>] [--solver-arg <arg>]",
        positional: &[MODEL_FILE_ARG],
    ...
    CommandSpec {
        ...
        usage: "valid orchestrate <target> [--json] [--progress=json] [--backend=<...>] [--solver-exec <path>] [--solver-arg <arg>]",
        positional: &[MODEL_FILE_ARG],
    ...
    CommandSpec {
        ...
        usage: "valid testgen <target> [--json] [--progress=json] [--property=<id>] [--profile=<id>] [--strategy=<...>] [--backend=<...>] [--solver-exec <path>] [--solver-arg <arg>]",
        positional: &[MODEL_FILE_ARG],
    ...
    CommandSpec {
        ...
        usage: "valid distinguish <target> [--compare=<other-model-file>] [--property=<id>] [--compare-property=<id>] [--max-depth=<n>] [--json] [--progress=json]",
        positional: &[MODEL_FILE_ARG],
        options: &[JSON_ARG, PROGRESS_ARG],
        request_schema: None,
        response_schema: None,
    ...
    CommandSpec {
        ...
        usage: "valid coverage <target> [--json] [--progress=json] [--property=<id>] [--backend=<...>] [--solver-exec <path>] [--solver-arg <arg>]",
        positional: &[MODEL_FILE_ARG],
