...
const VALID_COMMANDS: &[CommandSpec] = &[
    ...
    CommandSpec {
        ...
        usage: "valid check <target> [--json] [--progress=json] [--property=<id>] [--backend=<explicit|mock-bmc|sat-varisat|smt-cvc5|command>] [--solver-exec <path>] [--solver-arg <arg>]",
        positional: &[MODEL_FILE_ARG],
    ...
    CommandSpec {
        ...
        usage: "valid explain <target> [--json] [--progress=json] [--property=<id>] [--backend=<...>] [--solver-exec <path>] [--solver-arg <arg>]",
        positional: &[MODEL_FILE_ARG],
    ...
    CommandSpec {
        ...
        usage: "valid trace <target> [--format=mermaid-state|mermaid-sequence|json] [--property=<id>] [--json] [--progress=json] [--backend=<...>] [--solver-exec <path>] [--solver-arg <arg>]",
        positional: &[MODEL_FILE_ARG],
    ...
    CommandSpec {
        ...
        usage: "valid testgen <target> [--json] [--progress=json] [--property=<id>] [--strategy=<...>] [--backend=<...>] [--solver-exec <path>] [--solver-arg <arg>]",
        positional: &[MODEL_FILE_ARG],
